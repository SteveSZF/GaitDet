...
def main(args):
    ...
    #cfg_file_path = './yolov3-custom-deploy.cfg'
    ...
    output_tensor_dims['082_convolutional'] = [18, 13, 13]
    output_tensor_dims['094_convolutional'] = [18, 26, 26]
    output_tensor_dims['106_convolutional'] = [18, 52, 52]
    ...
    output_file_path = args.onnx
    onnx.save(yolov3_model_def, output_file_path)

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="yolov3")
    parser.add_argument('--weight', type=str, default=None, help='trained model path')
    parser.add_argument('--cfg', type=str, default=None, help='cfg path')
    parser.add_argument('--onnx', type=str, default=None, help='onnx path')
